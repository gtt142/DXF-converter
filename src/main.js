...
function saveAllLayers() {
    ...
    dxfFile.pushLayer({layerName: 'layer_1', layerColor: Dxf.colors.BLUE});
    dxfFile.pushLayer({layerName: 'layer_0', layerColor: Dxf.colors.AQUA, layerStyle: Dxf.lineStyles.LONG_DASHED_DOTTED});
